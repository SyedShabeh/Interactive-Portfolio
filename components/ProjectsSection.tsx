        ...
        <section id="projects" className="h-screen w-full relative z-10 overflow-hidden bg-black">
            <div className="absolute top-12 left-0 right-0 z-20 pointer-events-none px-6">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-4xl font-bold mb-8 text-neon-green border-b border-white/10 pb-4 text-center [text-shadow:0_0_15px_rgba(0,255,0,0.5)]">Featured Projects</h2>
                </div>
            </div>
