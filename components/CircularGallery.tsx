...
class App {
    ...
    constructor(
        container: HTMLElement,
        {
            ...
            scrollSpeed = 2,
            scrollEase = 0.05
        }: { items: Project[] } & Omit<CircularGalleryProps, 'items'>
    ) {
    ...
    handleClick(x: number) {
        ...
        // Find the media item under the cursor
        ...
        if (clickedMedia && clickedMedia.project.link !== '#') {
            window.open(clickedMedia.project.link, '_blank');
        }
    }
